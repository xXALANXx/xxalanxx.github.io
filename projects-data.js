...
window.PROJECTS_DATA = [
  ...
  },
  {
    ...
    longDesc: "Stage 1: What?\nDuring the testing phase of Project 3, our team evaluated the structural integrity of our 3D-printed wheelchair storage bracket by vigorously shaking it to simulate the oscillating motion of Mark's wheelchair. As the team manager who personally calibrated the CAD (Computer-Aided Design) models and 3D-printed the parts using PLA (Polylactic Acid) filament, I initially felt a sharp sense of disappointment when I heard the plastic crack under an estimated 40-Newton simulated horizontal force. The curved portions of the bracket visibly fractured when significant downward stress was applied, revealing a critical flaw in how our geometry handled weight distribution. To troubleshoot this, we assessed the physical damage and realized that the storage unit carried the vast majority of its load at the front, rendering our initial curved support mechanism inadequate. This failure forced us to apply personal engineering judgment: we needed to extend the flat portion of the bracket to reduce the load on the curves, modify the diagonal supports, and pivot away from brittle PLA to PETG (Polyethylene Terephthalate Glycol) for enhanced material durability. Looking at the fractured prototype, I recognized that our expectation of a simple, superglue-assembled PLA print was naive compared to the actual physical demands and unpredictable forces of a moving wheelchair.\n\nStage 2: So What?\nThe primary challenge we faced was the unexpected structural failure of our bracket under vertical stress, but this incident was ultimately a success because it exposed a critical oversight before we delivered a faulty product to our client. This experience mattered profoundly to my learning because it shattered my misconception that a successful digital CAD model automatically translates to a functional, durable physical product in the real world. My perspective on the design process fundamentally changed; I now understand that early, rigorous physical testing is not just a validation checklist, but an essential iterative tool for uncovering invisible load-bearing flaws that digital models simply cannot replicate.\n\nStage 3: Now What?\nI learned that deliberate material selection and rigorous physical stress-testing are just as critical as the conceptual geometric design itself. Moving forward into future mechanical engineering projects, I will apply this learning by prototyping load-bearing components much earlier in the timeline, utilizing robust materials like PETG or ABS from the outset rather than waiting for late-stage failures. Considering this experience, I will set a specific goal to incorporate basic physical stress simulations into the early prototyping phase of all future designs to preemptively identify structural weak points before final fabrication.",
